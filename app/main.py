...
app.add_middleware(
    ...
    allow_origins=[
        ...
        "https://ecommerce-website-umeshpathakamuri1611-1875s-projects.vercel.app",
        "https://ecommerce-website-fo24sj51s-umeshpathakamuri1611-1875s-projects.vercel.app",
        "https://udmbackend.vercel.app",
    ],
    allow_origin_regex=r"https://ecommerce-website-.*\.vercel\.app",
